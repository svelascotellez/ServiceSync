      ...
      <section style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '4rem 1.5rem', textAlign: 'center' }}>
        <div className="animate-fade-in" style={{ maxWidth: '800px' }}>
          ...
          <div style={{ display: 'flex', gap: '1.5rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link href="/dashboard" className="glass-panel" style={{ padding: '2rem', flex: '1 1 200px', display: 'flex', flexDirection: 'column', gap: '1rem', textDecoration: 'none', transition: 'transform 0.2s', cursor: 'pointer' }} 
            ...
            <Link href="/supervisor" className="glass-panel" style={{ padding: '2rem', flex: '1 1 200px', display: 'flex', flexDirection: 'column', gap: '1rem', textDecoration: 'none', transition: 'transform 0.2s', cursor: 'pointer' }} 
               onMouseOver={(e) => e.currentTarget.style.transform = 'translateY(-5px)'}
               onMouseOut={(e) => e.currentTarget.style.transform = 'translateY(0)'}>
              <div style={{ fontSize: '2rem' }}>👔</div>
              <h3 style={{ fontSize: '1.25rem', fontWeight: 600 }}>Supervisores</h3>
              <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem' }}>Gestiona la ejecución de tareas y coordina trabajadores.</p>
            </Link>
            
            <Link href="/worker" className="glass-panel" style={{ padding: '2rem', flex: '1 1 200px', display: 'flex', flexDirection: 'column', gap: '1rem', textDecoration: 'none', transition: 'transform 0.2s', cursor: 'pointer' }}
               onMouseOver={(e) => e.currentTarget.style.transform = 'translateY(-5px)'}
               onMouseOut={(e) => e.currentTarget.style.transform = 'translateY(0)'}>
              <div style={{ fontSize: '2rem' }}>👷</div>
            ...
            <Link href="/resident" className="glass-panel" style={{ padding: '2rem', flex: '1 1 200px', display: 'flex', flexDirection: 'column', gap: '1rem', textDecoration: 'none', transition: 'transform 0.2s', cursor: 'pointer' }}
               onMouseOver={(e) => e.currentTarget.style.transform = 'translateY(-5px)'}
               onMouseOut={(e) => e.currentTarget.style.transform = 'translateY(0)'}>
              <div style={{ fontSize: '2rem' }}>🏡</div>
