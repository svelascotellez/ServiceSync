...
export default function WorkerClient({ tasks, attendancesHistory = [] }: { tasks: any[], attendancesHistory?: any[] }) {
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="glass-panel" style={{ marginTop: '3rem', padding: '1.5rem', overflowX: 'auto' }}>
        <h2 style={{ fontSize: '1.25rem', fontWeight: 600, marginBottom: '1rem' }}>Historial de Asistencia</h2>
