...
import { formatCancunDate, formatCancunDateTime, formatCancunTime } from '@/lib/dateUtils';
...
export function WorkerDossierModal({ worker, onClose }: WorkerDossierModalProps) {
  ...
  return (
    <div style={{
      position: 'fixed',
      inset: 0,
      backgroundColor: 'rgba(8, 28, 44, 0.75)',
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.25rem', fontWeight: 700, color: 'var(--gold)', margin: 0 }}>
          ...
          <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
            <button 
              ...
              style={{ padding: '0.4rem 0.85rem', fontSize: '0.85rem', color: 'var(--gold)', borderColor: 'var(--gold)' }}
            >
        ...
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: '240px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', flexWrap: 'wrap' }}>
              <h1 style={{ fontSize: '1.5rem', fontWeight: 800, margin: 0 }}>{worker.name}</h1>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '1rem' }}>
                <div style={{ padding: '1rem', borderRadius: '0.5rem', backgroundColor: 'var(--background)', border: '1px solid var(--border)' }}>
                  ...
                  <div style={{ fontSize: '1.75rem', fontWeight: 800, color: 'var(--primary)', marginTop: '0.25rem' }}>{totalTasks}</div>
                </div>

                <div style={{ padding: '1rem', borderRadius: '0.5rem', backgroundColor: 'var(--background)', border: '1px solid var(--border)' }}>
                  <div style={{ fontSize: '0.75rem', color: 'var(--success)', fontWeight: 600 }}>Completadas / Aprobadas</div>
                  <div style={{ fontSize: '1.75rem', fontWeight: 800, color: 'var(--success)', marginTop: '0.25rem' }}>{completedTasks}</div>
                </div>

                <div style={{ padding: '1rem', borderRadius: '0.5rem', backgroundColor: 'var(--background)', border: '1px solid var(--border)' }}>
                  <div style={{ fontSize: '0.75rem', color: 'var(--warning)', fontWeight: 600 }}>Pendientes / En Progreso</div>
                  <div style={{ fontSize: '1.75rem', fontWeight: 800, color: 'var(--warning)', marginTop: '0.25rem' }}>{pendingTasks}</div>
                </div>

                <div style={{ padding: '1rem', borderRadius: '0.5rem', backgroundColor: 'var(--background)', border: '1px solid var(--border)' }}>
                  <div style={{ fontSize: '0.75rem', color: 'var(--gold)', fontWeight: 600 }}>Tasa de Puntualidad</div>
                  <div style={{ fontSize: '1.75rem', fontWeight: 800, color: 'var(--gold)', marginTop: '0.25rem' }}>{punctualityRate}%</div>
                </div>
              </div>
